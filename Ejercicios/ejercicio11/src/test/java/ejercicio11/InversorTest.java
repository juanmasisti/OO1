...
class InversorTest {
	...
	void setUp() throws Exception {
		...
		plazoFijo = (Inversion) new PlazoFijo(fecha,100, 0.05);
		inversion = (Inversion) new InversionEnAcciones("SoyUnaInversion", 10, 10);
		plazoFijo2 = (Inversion) new PlazoFijo(LocalDate.now(),100, 0.05);
	}
